...
pub fn is_paused(paused: Option<Res<PauseState>>) -> bool {
    paused.is_some_and(|paused| paused.is_paused())
}
...
pub fn is_user_paused(paused: Option<Res<PauseState>>) -> bool {
    paused.is_some_and(|paused| paused.is_user_paused())
}
...
pub fn is_menu_paused(paused: Option<Res<PauseState>>) -> bool {
    paused.is_some_and(|paused| paused.is_menu_paused())
}
